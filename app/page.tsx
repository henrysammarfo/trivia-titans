      ...
      <main className="flex-grow">
        ...
        <section className="py-12 -mt-24 relative z-20 container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {[
              { icon: Crown, label: t('stats.totalPlayers'), value: totalTitans, color: "text-gold-dark", gradient: "from-gold/20 to-gold/5", border: "border-gold/30" },
              { icon: Swords, label: t('stats.totalGames'), value: totalGames, color: "text-aegean", gradient: "from-aegean/20 to-aegean/5", border: "border-aegean/30" },
              { icon: ScrollText, label: t('stats.avgScore'), value: leaderboardData.length > 0 ? Math.round(leaderboardData.reduce((acc, p) => acc + p.average_score, 0) / leaderboardData.length) : 0, color: "text-aegean-dark", gradient: "from-aegean/20 to-aegean/5", border: "border-aegean/30" }
            ].map((stat, index) => (
              <motion.div
                key={index}
                initial={{ opacity: 0, y: 20 }}
        ...
        <section id="leaderboard" className="py-16 container mx-auto px-4 scroll-mt-24">
          <div className="flex flex-col md:flex-row items-center justify-between mb-10 gap-6">
            <div className="text-center md:text-left">
              <h2 className="text-4xl font-heading font-bold text-aegean-dark mb-2">{t('leaderboard.pantheon')}</h2>
              <p className="text-stone-600 text-lg">{t('leaderboard.pantheonSubtitle')}</p>
            </div>
          </div>
        ...
        <section id="about" className="py-16 bg-white/50 border-t border-gold/20 scroll-mt-24">
          <div className="container mx-auto px-4 text-center max-w-3xl">
            <h2 className="text-3xl font-heading font-bold text-aegean-dark mb-8">{t('howItWorks.title')}</h2>
            <div className="grid md:grid-cols-3 gap-8">
              <div className="p-6 rounded-xl bg-white/95 shadow-md border-2 border-aegean/10 hover:border-aegean/30 transition-colors">
                ...
                <h3 className="font-heading font-bold text-xl mb-3 text-aegean-dark">{t('howItWorks.step1Title')}</h3>
                <p className="text-obsidian/80 font-medium leading-relaxed">{t('howItWorks.step1Desc')}</p>
              </div>
              <div className="p-6 rounded-xl bg-white/95 shadow-md border-2 border-gold/10 hover:border-gold/30 transition-colors">
                ...
                <h3 className="font-heading font-bold text-xl mb-3 text-gold-dark">{t('howItWorks.step2Title')}</h3>
                <p className="text-obsidian/80 font-medium leading-relaxed">{t('howItWorks.step2Desc')}</p>
              </div>
              <div className="p-6 rounded-xl bg-white/95 shadow-md border-2 border-aegean/10 hover:border-aegean/30 transition-colors">
                <div className="w-14 h-14 bg-aegean-dark text-white rounded-full flex items-center justify-center mx-auto mb-4 font-heading font-bold text-2xl shadow-lg border-4 border-white">3</div>
                <h3 className="font-heading font-bold text-xl mb-3 text-aegean-dark">{t('howItWorks.step3Title')}</h3>
                <p className="text-obsidian/80 font-medium leading-relaxed">{t('howItWorks.step3Desc')}</p>
              </div>
            </div>
          </div>
        </section>
